...
public class PauseMenu : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (bikeController != null)
        {
            isActive[0] = (bikeController.enterZone0_Count == 1 && isStart);
            isActive[1] = (bikeController.enterZone1_Count == 1 && isStart);
            isActive[2] = (bikeController.enterZone2_Count == 1 && isStart);
            isActive[3] = (bikeController.enterZone3_Count == 1 && isStart);
            isActive[4] = (bikeController.enterZone4_Count == 1 && isStart);
            isActive[5] = (bikeController.enterZone5_Count == 1 && isStart);
            isActive[6] = (bikeController.enterZone6_Count == 1 && isStart);
            isActive[7] = (speedMonitor.zone_num == 7 && scoringSystem.isPass && isStart);
            isActive[8] = (speedMonitor.zone_num == 7 && !scoringSystem.isPass && isStart);
        }
    ...
    IEnumerator Pause_Start()
    {
        ...
        {
            speedMonitor.Initialize();
            speedMonitor.speedText.gameObject.SetActive(false);
            scoringSystem.scoreText.gameObject.SetActive(false);
            //센서 입력 시 해당 부분 변경
            if (Input.GetKeyDown(KeyCode.Space))
            {
                speedMonitor.speedText.gameObject.SetActive(true);
                scoringSystem.scoreText.gameObject.SetActive(true);
